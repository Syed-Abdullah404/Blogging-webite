                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="./img/adminpost/<?php echo $row['image'] ?>" alt="" width="200px" height="130px"></td>
                                    <td><?php echo $row['post']; ?></td>
                                    <td><?php echo $row['subject']; ?></td>
                                    <td>
                                        <button type="button" class="btn btn-lg btn-lg-square btn-success editbtn" data-bs-toggle="modal" data-bs-target="#editModal" value="<?php echo $row['id'] ?>">
...
if (isset($_POST['submit'])) {
    ...
    $img = move_uploaded_file($_FILES["image"]["tmp_name"], "./img/adminpost/" . $filename);
...
if (isset($_POST['delete'])) {
    ...
    $id = $_POST['id'];
    $query = $con->query("DELETE FROM `postbyadmin` WHERE id = '$id'");
...
if (isset($_POST["editService"])) {
    ...
    $update = "UPDATE `postbyadmin` SET `subject`= '$cat', `image` = '$check', `post` = '$desc' where `id` = $id";
