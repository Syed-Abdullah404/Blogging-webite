                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.php" class="">
                                <h3 class="text-primary"><img src="./img/logo/logo.png" alt="" height="60px"></h3>
                            </a>
                            <center>
                            <h3>Sign In</h3>
                            </center>
...
$result = $con->query("SELECT * FROM blogger WHERE email='$email' and `password`='$password'AND status ='approve'");
...
?>
  <script>
  window.location = "<?php echo 'Posts.php'?>";
</script>
<?php
}else{
