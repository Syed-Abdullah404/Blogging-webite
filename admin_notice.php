		...
		<div class="left-sidebar  side" style="border-radius: 6px;">
			<div class="imp-links dark-theme " style="margin-left: 0px;border: 0px;">
				<div style="margin-left:56px ;">
					<!-- <img src="images/ucpLogo.png" class="logo" width="270px" height="160px" style="margin-bottom: 41px; margin-top: 14px;"> -->
					<?php
$query = $con->query("SELECT * FROM `companyprofile`");
while ($row = $query->fetch_assoc()) { 
	?>
...
?>
					...
					<div class="modal-body">
						<form method="Post" enctype="multipart/form-data">
							<div class="mb-3">
								...
								<input class="form-control" type="text" name="email" id="formFile" placeholder="Your valid Email">
		...
		<div class="main-content ">
			...
			<?php
			$queryblogger = $con->query('SELECT * FROM `postbyadmin` ORDER BY id DESC;');
			...
			?>
				...
				<div class="post-container">
					...
					<div class="post-row">
						<?php
						$query = $con->query('SELECT * FROM `admin_signup` rsort');
						while ($adminName = $query->fetch_assoc()) {
							$name = $adminName['name'];
							$image = $adminName['image'];
						}
						?>
						<div class="user-profile">
							<img src="./admin/img/img_avatar.png" height="45px">
							<div>
					...
					if ($image) {
					?>
						<img src="./admin/img/adminpost/<?php echo  $image; ?>" class="post-img">
					<?php
					} else {
					}
		...
		<div class="right-sidebar">
			...
			?>
				<div class="online-list">
					...
					<div class="online">
					<img src="./admin/img/department/<?php echo $row['image'];?>" width="12px" height="50px">					</div>
